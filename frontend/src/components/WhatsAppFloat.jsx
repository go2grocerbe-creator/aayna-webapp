...
export default function WhatsAppFloat({ clearStickyBar = false }) {
  ...
  return (
    <a
      ...
      className={`fixed right-5 md:right-8 md:bottom-8 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-lg z-50 hover:scale-110 transition-transform duration-300 ${
        clearStickyBar ? "bottom-24" : "bottom-5"
      }`}
    >

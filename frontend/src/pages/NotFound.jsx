  ...
  return (
    <div data-testid="not-found-page" className="max-w-2xl mx-auto px-4 sm:px-6 py-20 md:py-28 text-center">
      <div className="h-16 w-16 rounded-full bg-aayna-mist flex items-center justify-center mx-auto mb-6">
        <Compass className="h-8 w-8 text-aayna-burgundy" />
      </div>
      <p className="text-aayna-burgundy font-medium text-sm tracking-wide uppercase mb-2">404</p>
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center mt-8">
        ...
        <Link
          ...
          className="h-12 px-8 border border-aayna-burgundy text-aayna-burgundy font-semibold inline-flex items-center justify-center hover:bg-aayna-mist transition-colors"
        >
          Continue Shopping
        </Link>
      </div>

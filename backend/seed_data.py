...
SEED_PRODUCTS = [
    ...
    _product(
        ...
        "Soft rose drop earrings with a stone-inspired finish.",
        "A romantic pair of rose quartz-style drop earrings designed for soft, everyday outfits. Best for brunch, casual events, and gifting.",
    ...
    _product(
        ...
        "A layered gold-tone chain necklace that adds instant detail to simple outfits. Adjustable length for flexible styling.",
    ...
    _product(
        ...
        "An adjustable ring featuring a rose-toned stone detail. Easy to wear and suitable for everyday or occasional styling.",
    ...
    _product(
        ...
        "A gold-tone stack ring set for mixing and matching. Designed for customers who like a styled, social-media-ready look.",
    ...
    _product(
        ...
        "A set of soft blush satin-style scrunchies designed for daily hair styling. Gentle, soft, and easy to pair with casual outfits.",
    ...
    _product(
        ...
        "A gold butterfly hair clip for soft, everyday styling.",
